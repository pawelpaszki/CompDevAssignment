...
var Header = React.createClass({
    ...
    var headerValue = this.props.headerValue;
		return (
      <div>
        <Link to="/api/users" ><button style={{marginRight: 1 + 'em', marginTop: 1 + 'em', paddingLeft: 10 + 'px', paddingRight: 6 + 'px'}} className="nav btn-primary navbar-nav navbar-right">Home</button></Link>
